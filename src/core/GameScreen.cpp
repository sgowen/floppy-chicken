...
void GameScreen::init()
{
    ...
    m_okButton = std::unique_ptr<GameButton>(new GameButton(4.875f, 11.0f, 3.75f, 1.21875002f));
    m_leaderboardsButton = std::unique_ptr<GameButton>(new GameButton(13.0f, 11.0f, 6.0f, 3.0f));
    m_gameState = WAITING;
    m_iScreenState = 0;
    m_fColor = 0;
    m_fTitleAlpha = 1;
