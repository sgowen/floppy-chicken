...
JNIEXPORT void JNICALL Java_com_technegames_floppycock_platform_PlatformFileUtils_init_1asset_1manager(JNIEnv * env, jclass jclazz, jobject java_asset_manager)
{
	UNUSED(jclazz);
