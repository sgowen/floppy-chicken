...
import com.technegames.floppycock.platform.PlatformFileUtils;
...
public final class RendererWrapper implements Renderer
{
	 ...
	 */
	private static final short FLAP_SOUND = 1;
	...
	public RendererWrapper(MainActivity activity, int deviceScreenWidth, int deviceScreenHeight)
	{
		...
		this.flapSound = audio.newSound("flap.ogg");
	...
	public void onDrawFrame(GL10 gl)
	{
		...
		switch (gameState)
		{
			...
			case 4:
				clear_state();
				activity.submitBestScoreToLeaderboard();
				break;
			default:
				break;
		}
	...
	private void handleSoundId(short soundId)
	{
		...
		{
			case FLAP_SOUND:
				this.flapSound.play(1);
				break;
			case SCORE_SOUND:
				this.scoreSound.play(1);
				break;
			case HIT_SOUND:
				this.hitSound.play(1);
				break;
			case LAND_SOUND:
				this.landSound.play(1);
				break;
			default:
				break;
		}
